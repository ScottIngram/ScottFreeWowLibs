...
MouseClick = {
    ...
    FOUR   = "Button4",
    FIVE   = "Button5",
    RESERVED_FOR_KEYBIND = "Button6", -- there is no "Button6" in the API docs, so,  I've reserved this for use by my keybind code
    SEVEN  = "Button7", -- ditto
    EIGHT  = "Button8", -- ditto
    NINE   = "Button9", -- ditto
    TEN    = "Button10", -- ditto
...
MouseClickAsSecEnvId = {
    ...
    [MouseClick.RESERVED_FOR_KEYBIND] = "type6",
...
MouseClickAsSecEnvN = {
    ...
    [MouseClick.FOUR]   = 4,
    [MouseClick.FIVE]   = 5,
    [MouseClick.RESERVED_FOR_KEYBIND]= 6,
    [MouseClick.SEVEN]  = 7,
    [MouseClick.EIGHT]  = 8,
    [MouseClick.NINE]   = 9,
    [MouseClick.TEN]    = 10,
